    ...
    <b-overlay :show="is_busy" rounded="sm">
        <div class="container-fluid">
            <div class="row mb-2 p-2">
                <div class="col-md-4">
                    <h2><strong>List of Production</strong></h2>
                </div>

                <div class="col-md-8">
                    <router-link to="/production/create" class="pull-right m-2">
                    ...
                    <b-modal id="filter-modal" ref="filter" title="Filter" hide-footer>
                        <b-form @submit.stop.prevent="onFilterSubmit">
                            ...
                            <b-form-group label="Production Code:">
                ...
                <div class="card-body table-responsive p-0" v-if="productions.data.length>0">
                    <table class="table table-hover">
                        ...
                        <tr v-for="production in productions.data" :key="production.production_id">
                            ...
                            <td>
                                <router-link :to="'/production/' + production.production_id">
...
<script>
    ...
    export default {
        ...
        methods: {
            getResults(page = 1) {
                axios.get("/api/production?page=" + page)
                .then(response => {
            ...
            loadProduction() {
                ...
                this.is_busy = true;
                axios.get("/api/production", { params: this.filterForm })
                .then(({ data }) => {
